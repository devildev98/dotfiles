...
static const char *fonts[]          = { "FiraCode Nerd Font:size=13", "Noto Color Emoji;pixelsize=13;antialias=true;autohint=true"};
...
static const char *alacmd[]  = { "alacritty", "-e", "fish" };
