...
# Changing "ls" to "exa"
abbr ls='exa -al --color=always --group-directories-first --icons' # my preferred listing
abbr la='exa -a --color=always --group-directories-first --icons'  # all files and dirs
abbr ll='exa -l --color=always --group-directories-first --icons'  # long format
abbr lt='exa -aT --color=always --group-directories-first --icons' # tree listing
